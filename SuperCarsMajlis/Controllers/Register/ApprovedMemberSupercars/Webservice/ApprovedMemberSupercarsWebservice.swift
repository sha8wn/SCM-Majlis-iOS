//
//  ApprovedMemberSupercarsWebservice.swift
//  SuperCarsMajlis
//
...
extension ApprovedMemberSupercarsViewController{
    ...
    func callUpdateSuperCarsAPI(car_Id: String, brand_Id: Int, model_Id: Int, color_Id: Int, imageArray: [Any], docsArray: [Any]){
